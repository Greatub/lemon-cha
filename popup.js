...
Object.assign(UI_TEXT, {
  "zh-TW": {
    ...
    settingsTabs: "設定分類",
    colorSchemeLabel: "配色方案",
    colorSchemeLlmon: "llmon cha 預設（淺色 / 深色）",
  ...
  "ja-JP": {
    ...
    settingsTabs: "設定カテゴリ",
    colorSchemeLabel: "配色",
    colorSchemeLlmon: "llmon cha 既定（ライト / ダーク）",
  ...
  "ko-KR": {
    ...
    colorSchemeLlmon: "llmon cha 기본 (라이트 / 다크)",
  ...
  "fr-FR": {
    ...
    colorSchemeLlmon: "llmon cha par défaut (clair / sombre)",
  ...
  "es-ES": {
    ...
    languageTraditionalChinese: "Chino tradicional",
    ...
    colorSchemeLlmon: "llmon cha predeterminado (claro / oscuro)",
  ...
  "de-DE": {
    ...
    languageTraditionalChinese: "Traditionelles Chinesisch",
    ...
    colorSchemeLlmon: "llmon cha Standard (Hell / Dunkel)",
